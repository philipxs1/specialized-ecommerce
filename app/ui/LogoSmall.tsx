...
const LogoSmall = ({ color = "black" }: LogoSmallProps) => {
  const colors: Record<"black" | "white", string> = {
    black: "#000000",
    white: "#FFFFFF",
  };
  const fillColor = colors[color as "black" | "white"] || color;
  return (
    <svg
